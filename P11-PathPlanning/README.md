...
Actually, this is a very great attempt as I can see you put a lot of effort to accomplish this project. Hope you enjoyed working on the project.
...
#### Resources
Here is another great paper written by our own Sebastian Thrun which discusses the practical search techniques in path planning. : http://ai.stanford.edu/~ddolgov/papers/dolgov_gpp_stair08.pdf

This is another great resource based on "A path planning and obstacle avoidance algorithm for an autonomous robotic vehicle" which you might want to read. : https://webpages.uncc.edu/~jmconrad/GradStudents/Thesis_Ghangrekar.pdf
