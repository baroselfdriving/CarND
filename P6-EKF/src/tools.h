...
public:
  ...
  */
  ...
  /**
   * Transform radar measurement in polar coordinates to state vector in cartesian coordinates
   */
  static Eigen::VectorXd TransformRadarMeasurement(const Eigen::VectorXd& radar_measurement);
};
